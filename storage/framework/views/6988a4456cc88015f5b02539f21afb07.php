<div class="about">
    <div class="container_width">
        <div class="row d_flex grig">
            <div class="col-md-6">
                <div class="about_img">
                    <figure><img src="<?php echo e(asset('assets/images/about_img.jpg')); ?>" alt="#" />
                    </figure>
                </div>
            </div>
...
<?php /**PATH C:\Web Template\laravel10\client3-bliss\resources\views/components/about.blade.php ENDPATH**/ ?>